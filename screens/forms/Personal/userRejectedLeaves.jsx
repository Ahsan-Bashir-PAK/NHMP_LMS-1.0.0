...
return (
    ...
    <View className=" flex flex-col p-2 bg-white  h-screen  ">
      <KeyboardAvoidingView style={{ backgroundColor: 'white' }}>
        ...
        {/* Status  Of Leaves */}
        <View className=" bg-red-800 mt-1 w-full rounded-md  ">
          <View className="  rounded-md p-1 m-1 w-fit items-center justify-center flex-col ">
            <Text className="text-white text-lg rounded-md font-bold "> Rejected Leaves</Text>
   ...
   {/* Approved Days*/}
      {/* ======================== Heading====*/}
      <View className={` flex-row m-2  justify-evenly items-center  bg-slate-200 p-2` }>
...
<View className={` flex-row m-2  justify-evenly items-center  bg-white p-1 border-b border-dotted border-gray-400` } key={index}>
   <View className=" w-2/12 flex justify-center text-center items-center" >
        ...
        <View className=" w-3/12 flex justify-center items-center" >
             <Text className="text-red-500 text-xs text-center">{item.leaveType}</Text>
        </View> 
       <View className=" w-3/12 flex justify-center  items-center" >
